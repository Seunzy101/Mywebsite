    ...
    <section className="py-20 px-4 md:px-10 lg:px-20 bg-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          <p className="text-yellow-500 uppercase font-semibold">Popular Destinations</p>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start gap-4">
                  <div>
                    <h3 className="text-2xl font-bold text-[#032B5B]">{item.city}</h3>
                    <p className="text-gray-500 mt-1">{item.country}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm text-gray-500">From</p>
                    <h4 className="text-xl font-bold text-yellow-500">{item.price}</h4>
                  </div>
                </div>

                <button
                  onClick={() => handleBook(item)}
                  className="mt-4 w-full bg-yellow-400 hover:bg-yellow-500 text-white px-6 py-3 rounded-xl transition font-semibold"
                >
                  Book Now
                </button>
              </div>
